...
```{r}
baseurl <- paste0("http://api.nytimes.com/svc/search/v2/articlesearch.json?q=immigrant OR migrant OR migration OR refugee OR asylum OR undocumented", 
...
not_news_variable <- c("Op-Ed","Editorial","Interactive Feature", "Review", "Letter", "Correction","List")
